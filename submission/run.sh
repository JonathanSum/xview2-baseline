...
# 2) input pre image 
# 3) input post image 
# 4) output localization image 
# 5) output localization+classifcation image

if [ $# -lt 5 ]; then 
        echo "run.sh: /path/to/xview2-baseline/ /path/to/input/pre/image /path/to/input/post/image /path/to/localization/output/image /path/to/classifcation/output/image" 
else
